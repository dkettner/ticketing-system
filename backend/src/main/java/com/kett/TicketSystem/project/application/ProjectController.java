...
public class ProjectController {
    ...
    public ResponseEntity<ProjectResponseDto> postProject(@RequestBody ProjectPostDto projectPostDto) {
        // TODO: postingUserId must be generated by parsing and validating jwt token
        ProjectResponseDto projectResponseDto = ticketSystemService.addProject(projectPostDto, null);
